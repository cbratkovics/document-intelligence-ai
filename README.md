...
> and a reproducible local walkthrough.
...
- **Retrieval and generation:** hybrid retrieval, optional reranking, bounded context
...
- **Evaluation:** versioned judgments, explicit metric conventions,
  ...
  quality evidence.
- **Operations:** fail-closed index compatibility, bounded inputs,
