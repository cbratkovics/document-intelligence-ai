...
class TestConfig:
    ...
    def test_settings_from_env(self):
        ...
        with patch.dict(
            os.environ,
            {"OPENAI_API_KEY": "env-key", "CHUNK_SIZE": "500", "APP_ENV": "production"},
        ):
            settings = Settings()
    ...
    def test_chroma_url_property(self):
        ...
        settings = Settings(
            OPENAI_API_KEY="test", CHROMA_HOST="localhost", CHROMA_PORT=8001
        )
...
Different section content."""
        ...
        doc = Document(page_content=markdown_text, metadata={"extension": ".md"})
...
class TestDocumentLoader:
    ...
    def test_extract_pdf_text(self):
        ...
        with patch.object(
            loader, "_extract_pdf_text", return_value="Extracted PDF text"
        ):
...
class TestEmbeddingService:
    ...
    def test_find_similar_embeddings(self):
        ...
        results = service.find_similar_embeddings(
            query_embedding, embeddings, top_k=2, threshold=0.5
        )
